      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
	        ...
	        <li><a href="/user/register"><img src="/<?php echo path_to_theme(); ?>/images/sign_up.png" alt="Sign Up"> Sign Up</a></li>
...
<div id="main" class="clearfix main" role="main">
	<?php if ($page['main_random_image']): ?>
	<div id="random-images">
		<div class="container">
			<?php print render($page['main_random_image']); ?>
		</div>
	</div>
	<!-- /#random-images -->
    <?php endif; ?>
